...
urlpatterns = [
    path('', views.get_cities, name='calculator'),
    # path('calculator', views.calculator, name='calculator'),
    #path('calculator/', views.get_cities, name='calculator'),    
    # path('form', views.get_cities, name='cities'),
    path('result', views.result, name='result'), # ! the action of the form is this url which is an addition to the calculator/ one above
